...
Label(root, text ='Welcome To ', font = 'arial 20 bold').pack()
Label(root, text ='ENCODE DECODE', font = 'arial 20 bold').pack(side =BOTTOM)
...
def Mode():
    if(mode.get() == 'e'): # encode is called if e
        Result.set(Encode(private_key.get(), Text.get()))
    elif(mode.get() == 'd'): # decode is called if d
